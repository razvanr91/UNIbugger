...
namespace UNIbugger.Controllers
{
    public class TicketHistoriesController : Controller
    {
        ...
        {
            var applicationDbContext = _context.TicketHistories.Include(t => t.User);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,TicketId,Property,OldValue,NewValue,Created,Description,UserId")] TicketHistory ticketHistory)
        {
        ...
        private bool TicketHistoryExists(Guid id)
        {
