...
namespace UNIbugger.Controllers
{
    public class ProjectPrioritiesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name")] ProjectPriority projectPriority)
        {
            ...
            {
                projectPriority.Id = Guid.NewGuid();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,Name")] ProjectPriority projectPriority)
        {
        ...
        private bool ProjectPriorityExists(Guid id)
        {
