        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProjectPriorityId1 = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProjectId1 = table.Column<Guid>(type: "uuid", nullable: true),
                    TicketTypeId1 = table.Column<Guid>(type: "uuid", nullable: true),
                    TicketPriorityId1 = table.Column<Guid>(type: "uuid", nullable: true),
                    TicketStatusId1 = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Notifications_Tickets_TicketId1",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Notifications_TicketId1",
                table: "Notifications",
                column: "TicketId1");
